...
<p><button  type="button" id="btn" onClick="sal()" class="btn btn-primary btn-sm"><h5>Salida</h5></button></p>
  ...
  <p align="center" style="color:#00F"><img src="../img/logo.jpg" width="153" height="111"></p>
...
if(a[0]==0){
	document.getElementById('malo').innerHTML="Usuario no esta en la B.D,verifique e Intente de nuevo";
	}
if(a[0]>0){
	...
	document.getElementById('foto').innerHTML='<img src='+foto+' width="50%" height="50%"  >'
